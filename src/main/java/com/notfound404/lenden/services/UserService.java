...
public class UserService {
    ...
    private final String USER_FILE_PATH = System.getProperty("user.home") + "/Lenden/data/users.dat";
    private final String SESSION_FILE_PATH = System.getProperty("user.home") + "/Lenden/data/session.dat";
